...
//
// Error handling:
// - Validates all renderer operations
...
namespace Spectrum
{
    ...
    private:
        ...
        [[nodiscard]] bool ValidateRenderer(IRenderer* renderer) const noexcept;
        ...
        [[nodiscard]] bool ValidateActivationContext(const ActivationContext& context) const noexcept;

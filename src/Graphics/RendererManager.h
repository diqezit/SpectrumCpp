...
#include "Graphics/Visualizers/WaterfallRenderer.h"
...
namespace Spectrum {
    ...
    public:
        ...
        [[nodiscard]] std::string_view GetQualityName() const noexcept {
            ...
            static_assert(
                sizeof(k) / sizeof(k[0]) == size_t(RenderQuality::Count),
                "quality names must match RenderQuality");
    ...
    inline bool RendererManager::Initialize(int w, int h) {
        ...
        Add<WaterfallRenderer, S::Waterfall>();

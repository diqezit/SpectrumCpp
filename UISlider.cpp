...
namespace Spectrum {
    ...
    void UISlider::DrawGlow(GraphicsContext& context) const
    {
    ...
    void UISlider::DrawTrack(GraphicsContext& context) const
    {
    ...
    void UISlider::DrawThumb(GraphicsContext& context) const
    {
        const Rect thumbRect = GetThumbRect();
